...
class MemorialYflyerResults extends StatefulWidget {
  static String id = 'memorial_yflyer_results';
  const MemorialYflyerResults({Key? key}) : super(key: key);

  @override
  State<MemorialYflyerResults> createState() => _MemorialYflyerResultsState();
}

class _MemorialYflyerResultsState extends State<MemorialYflyerResults> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const FittedBox(
          ...
          child: Text(
            '2023 Memorial Day Series Y-Flyer Results',
            style: TextStyle(
